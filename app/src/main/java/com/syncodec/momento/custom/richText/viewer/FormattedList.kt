...
public fun @Composable RichTextScope.checkTaskMarkers(
	...
	Box(
		...
		if (it) {
			Icon(
				painter = painterResource(id = com.syncodec.momento.R.drawable.ic_checkbox_checked),
			...
			Icon(
				painter = painterResource(id = com.syncodec.momento.R.drawable.ic_checkbox_unchecked),
