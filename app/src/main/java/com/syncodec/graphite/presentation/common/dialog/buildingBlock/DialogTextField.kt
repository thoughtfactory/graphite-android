...
import com.syncodec.graphite.presentation.common.button.ActionButton
import com.syncodec.graphite.presentation.common.button.ActionButtonDefaults
...
fun DialogTextField(
	...
	Row(
		...
		ActionButton(
			...
			colors = ActionButtonDefaults.actionButtonColors(
