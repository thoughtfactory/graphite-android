 ...
 */
package com.syncodec.graphite.presentation.common.reorderable.lazyState
...
import androidx.compose.ui.unit.dp
import com.syncodec.graphite.presentation.common.reorderable.DragCancelledAnimation
import com.syncodec.graphite.presentation.common.reorderable.ItemPosition
import com.syncodec.graphite.presentation.common.reorderable.ReorderableState
...
fun rememberReorderableLazyStaggeredGridState(
    ...
    val state = remember(lazyStaggeredGridState) {
        ReorderableLazyStaggeredGridState(
    ...
    LaunchedEffect(state) {
        while (true) {
            ...
            lazyStaggeredGridState.scrollBy(diff)
        }
    }
    return state
}
...
class ReorderableLazyStaggeredGridState(
    ...
    override val visibleItemsInfo: List<LazyStaggeredGridItemInfo>
        get() = lazyStaggeredGridState.layoutInfo.visibleItemsInfo
