...
import com.syncodec.graphite.presentation.custom.pager.HorizontalPagerIndicator
import com.syncodec.graphite.presentation.custom.richText.viewer.*
import com.syncodec.graphite.presentation.custom.richText.viewer.string.RichTextString
import com.syncodec.graphite.presentation.custom.richText.viewer.string.RichTextStringStyle
import com.syncodec.graphite.presentation.custom.richText.viewer.string.Text
import com.syncodec.graphite.presentation.custom.richText.viewer.string.richTextString
...
fun ViewerComponent(
	...
	Column(
		...
		if (attachmentList.isNotEmpty()) {
			Thumbnail(attachmentMap = attachmentList)
		}
