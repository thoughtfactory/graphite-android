...
//						** Privacy Policy
                    ...
                    Column(modifier = Modifier) {
                        ...
                        ClickableText(
                            ...
                            style = MaterialTheme.typography.bodyMedium.copy(lineHeight = 18.sp, fontFamily = FontFamily(Font(R.font.roboto_regular))),
                            onClick = {
                                annotatedLinkString
...
private fun LoginWithGoogleButton(
    ...
    Image(
        painter = painterResource(R.drawable.st_continue_with_google),
...
//        colors = ButtonDefaults.buttonColors(containerColor = Color(0xFF131314), contentColor = Color(0xFFE3E3E3)),
