...
private fun DataGridView(
    ...
    BucketItemGridContainer(
        ...
        BookGridCard(
            ...
            onClick = { bucketItemBox ?: return@BookGridCard; if (isSelecting) selectionContainerActor.selectItem(objectBoxId = bucketItemBox.id) else onClickBucketItem(bucketItemBox) },
            onLongClick = { bucketItemBox ?: return@BookGridCard; selectionContainerActor.selectItem(objectBoxId = bucketItemBox.id) },
            dragHandle = {
