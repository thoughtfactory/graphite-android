...
private fun DataListView(
    ...
    BucketItemListContainer(
        ...
        ShowListCard(
            ...
            onClickStateButton = { bucketItemBox ?: return@ShowListCard; if (isSelecting) selectionContainerActor.selectItem(objectBoxId = bucketItemBox.id, allItemIdList = orderedIdList) else onUpdateBucketItemBoxState(bucketItemBox, bucketItemBox.nextState()) },
