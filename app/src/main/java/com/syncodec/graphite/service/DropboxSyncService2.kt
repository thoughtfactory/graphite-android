...
//@AndroidEntryPoint
//class DropboxSyncService2 : Service() {
//
...
//			} catch (e : Exception) {
//				Log.e("npr71", "connectWithDropbox: ${e.message}")
...
//	}
//
//	private suspend fun DbxClientV2.tryLock() {
...
//	}
//
//	private suspend fun DbxClientV2.lock(callback : suspend (Boolean) -> Unit) {
...
//				CoroutineScope(Dispatchers.IO).launch {
//					if (it == currentTimestamp.size.toLong()) callback(true) else callback(false)
//				}
//			}
//	}
//
